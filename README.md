...
the back end is somewhat co assisted not vibe coded....
the aiml part is fully done manually..
40%of the project is completed.
later each member will just understand the structure of their own responsibilities.....
me = aiml , api's and backend
ilham = backend
hannan = frontend
ausaaf = ppt
saad = researcher
